...
class Generator(nn.Module):
    ...
    def forward(self, image, text1, text2, z = None):
        ...
        #$$$$$$$$$$$$$$$$$$$ Attention $$$$$$$$$$$$$$$$$$
        attention_score = self.attention(fusion.view(-1, 16, 16, 512)) # N * 16 * 16 * 1
        weight = attention_score.view(-1, 1, 16, 16)  # N * 1 * 16 * 16
        ...
        # ones = torch.ones(img_feat.size(0), img_feat.size(1), img_feat.size(2), img_feat.size(3))
        fusion = img_feat_attention + img_feat #  * (ones - weight)
        # $$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$$
